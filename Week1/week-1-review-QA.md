...
1.2 What are the benefits of Java?
...
1.3 What is the difference between the JDK, JRE, and JVM?
	- JDK
...
1.4 In order to run a Java program, what needs to happen first?
...
1.5 What is the significance of the main method?
...
1.7 What naming conventions does Java utilize?
...
1.8 How can I write a Java application without an IDE such as Spring Tool Suite?
...
2.4 What is the purpose of packages in Java?
...
2.5 What is special about the java.lang package included in the Java runtime libraries?
...
2.9 How are primitives and references different from each other?
...
2.10 What does it mean when a reference type has a value of null?
...
2.11 What makes an object eligible for garbage collection?
...
2.13 What is a constructor and its purpose?
...
2.14 What is constructor overloading?
...
2.15 What is constructor chaining?
...
2.16 What are the two uses of the `this` keyword?
...
2.20 What does method return type mean?
...
2.21 What is the purpose of the `static` keyword?
...
3.2 What is a local git repository?
...
3.3 What is the difference between Git and Github?
	- Git is a version control software. Github is a place for (mostly) hosting remote git repositories. 
3.4 What are some of the other popular repository hosting websites besides Github?
	- Gitlab is one I think. Are they really even relevant? 
3.5 What is the purpose of configuring the SSH keys for Github and Git Bash?
	- So that git/github can verify your identity. Github especially doesn't like anonymous people pushing to repositories. 
3.6 Whenever we make changes to files or add/remove files from our local repository, what commands are needed to actually upload these changes to the remote repository?
...
3.7 What arithmetic operators are there?
	- +, -, *, /, % 
3.8 What is numeric promotion?
...
3.9 What are the assignment operators?
	- really theres just `=`. Every other assignment operator is really just a short hand combination, such as `+=`, `-=`, etc. 
3.10 What are the comparison operators?
	- ==, != , <, >, >=, <=
3.11 What are the logical operators?
	- !, &, &&, |, ||
3.12 What does short-circuiting mean with the logical operators? Which are the short-circuiting operators?
...
3.13 What two high level types of casting are there?
...
3.14 Why does a narrowing conversion need to be explicit?
...
3.15 Why does a widening conversion not need to be explicit?
	- Because going from a 32 bit datatype to a 64 bit datatype wont destroy any data, only create it. 
3.16 What is the difference between upcasting and downcasting?
	- Downcasting (casting a parent class type to a child type variable, dangerous)
	- upcasting (casting a child class type to a parent type variable)
3.17 What is an example of downcasting?
...
3.18 Why does downcasting need to be explicit?
...
3.19 What datatypes can a switch statement use?
	- byte, int, short, String, enum 
3.20 What is the difference between a while loop and do-while loop?
...
3.21 Write a for loop that prints numbers from 0 to 100 (inclusive), increasing
	- for(int i = 0; i<= 100; i++) {
	
		System.out.print(i + " "); 
	
	}
3.22 Write a while loop that prints numbers from 500 to 250 (inclusive), decreasing
	- int i = 500; 
	while(i >= 250) {
...
3.23 Can arrays change in size?
	- No, they are fixed size 
3.24 What is the syntax to instantiate an array?
	- int[] array = new int[5]; << = the `5` can be any number you want really 
3.25 How are object arrays different than primitive arrays in memory?
...
3.26 What is the for-each loop (enhanced for loop)?
...
4.2 Can we have multiple var-args parameters for one method?
...
4.3 Where does the var-args parameter need to go within the parameters?
...
4.4 What type of variable is the var-args parameter, reference or primitive?
...
4.5 What is the software development lifecycle?
...
4.6 What are the 7 phases of the software development lifecycle?
	- Requirments phase 
...
4.7 What two competing philosophies do we have?
	- Waterfall and Agile
4.8 What is waterfall and its characteristics?
...
4.9 What are the pros and cons of waterfall?
	- Pros
...
4.10 When might we use waterfall?
...
4.12 What are the core values of Agile?
	- Individuals and interactions over processes and tools 
	- Working software over comprehensive documentation 
	- Customer collaboration over contract negotiation 
	- Responding to change over following a plan 
4.13 What are the 12 principles of Agile?
...
4.14 What are some examples of Agile frameworks/methodologies?
	- Scrum 
	- Kanban 
...
4.17 What are the Scrum artifacts?
...
4.18 What is a product backlog?
	...
	to it. 
4.19 Who is in charge of managing the product backlog?
	- The "product owner", which is typically just a project manager
4.20 What is the Sprint backlog?
...
4.21 How is it decided what items/user stories are included in the Sprint backlog?
...
4.22 What is a usable product increment?
...
4.24 What is "Acceptance Criteria"?
...
4.25 What is the "Definition of Done"?
...
4.28 What Scrum roles are there?
	- Scrum master 
...
4.29 What is the role of a Scrum Master?
	- Oversee the scrum process. Help maintain sprint backlog. 
4.30 What is the role of the product owner?
	- Serve as point of contact between client and dev team. Maintain product backlog
4.31 How large should a Scrum team be?
	- No bigger than 10 people
4.32 What Scrum ceremonies are there?
	- Sprint planning meeting
	- Daily standup meeting 
	- Sprint review meeting 
	- Sprint retrospective 
4.33 What questions should be answered by each team member during the daily standup meeting?
	- What did you do yesterday? 
	- What will you do today? 
	- What issues/blockers have you run into? 
4.34 What is the difference between the Sprint Review and Sprint Retrospective meeting?
...
4.35 What is the purpose of the Java 8 Documentation? What is it actually documenting?
...
4.37 What are some common String methods?
...
4.38 What is Maven?
	...
	us. 
4.39 How do we include dependencies / external libraries into a Maven project?
...
4.40 What is the purpose of the pom.xml file?
...
4.41 What are the Maven project coordinates?
...
4.42 What is Javalin?
	- Javalin is a web framework for Java. It allows us to create web servers with Java.
4.43 What are the three layers in three-tiered architecture? [multitiered architecture] (https://en.wikipedia.org/wiki/Multitier_architecture)
	- Controller layer 
	- Service layer 
	- Data access layer
4.44 What is the purpose of the controller layer?
...
4.45 What is the purpose of the service layer?
...
4.46 What is the purpose of the data access layer?
...
## Day 5
5.1 What three primary actions does a web browser perform?
	- Render HTML/CSS
...
5.3 With regards to HTML, what is an attribute?
...
5.4 What is the difference between HTML, CSS, and JavaScript?
...
5.5 Where would we store our frontend files if we wanted to host them from our Javalin-based application?
	- In our resources folder. 
5.6 What is Selenium?
...
5.7 How do we set up Selenium in order to go to Google.com?
...
5.8 What Selenium locators do we have?
	- "Easy" locators 
		* name	
		* id	
		* class 
	...
	- "Hard" locators 
		* XPath 
		* CSS 
5.9 What method in Selenium allows us to type text into an element?
	- .sendKeys(String s); function
5.10 What method in Selenium allows us to click an element?
	- .click()