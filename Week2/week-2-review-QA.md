...
## Day 1
1.1 What is the purpose of inheritance?
...
1.2 What is a subclass / child class?
...
1.3 What is a superclass / base class?
...
1.4 What does the subclass inherit from the super class?
...
1.7 How is method overriding different than method overloading?
...
1.8 If Dog extends Animal, can you use an Animal reference variable to point to a Dog object?
...
1.9 If a method is first defined in the Dog class (not overridden from the Animal class), can we invoke that method from an Animal reference variable? If not, what do we need to do with that Animal reference variable? (hint: starts with down)
	...
	```
1.10 What is special about the Object class? 
...
1.11 What methods does the Object class contain?
...
1.12 What is the purpose of overriding the equals() method?'
...
1.13 If we do not override the equals() method, how does its implementation in the Object class work?
	- Its implementation in the Object class just checks to see if two reference variables point to the same object.  
1.14 What is the purpose of overriding the toString() method?
...
1.15 If we do not override the toString() method, what does it do by default?
	- It will just print out the package and class of the object, as well as the hashed memory location of the object. 
1.16 When overriding the equals() method, why do we also need to override the hashCode() method?
...
2.1 What access modifiers are there?
...
2.2 What is the difference between protected and default access modifiers?
...
2.3 What are the four pillars of OOP?
	- inheritance
	- encapsulation
	- polymorphism
	- abstraction
2.4 What is [inheritance](https://en.wikipedia.org/wiki/Inheritance_(object-oriented_programming))?
...
2.5 What is [polymorphism](https://en.wikipedia.org/wiki/Polymorphism_(computer_science))?
...
2.6 Is method overloading compile-time or runtime polymorphism, and why?
...
2.7 Is method overriding compile-time or runtime polymorphism, and why?
...
2.8 What is [encapsulation](https://en.wikipedia.org/wiki/Encapsulation_(computer_programming))?
...
2.9 What is [abstraction](https://en.wikipedia.org/wiki/Abstraction_(computer_science))?
...
2.11 What are getters and setters?
...
2.12 What access modifier should I generally be using to achieve encapsulation?
...
2.13 What is the purpose of the static keyword?
...
2.14 What can the final keyword be used with?
...
2.19 Is it possible for a class to implement multiple interfaces?
	- Yes. You could hypothetically implement as many interfaces as you like. 
2.20 In what version of Java was the `default` keyword introduced for interfaces, and what is the purpose of the default keyword?
...
2.21 If I declare a non-static method inside an interface, what implicit modifiers does it have?
	- public and abstract
2.22 If I declare a variable inside an interface, what implicit modifiers does it have?
	- public, static, and final 
---
## Day 3

3.1 What are wrapper classes?
...
3.6 Can Collections such as a List contain primitives or only objects?
...
3.7 What do we mainly use generics with?
